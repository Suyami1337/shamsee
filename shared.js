    ...
    <div class="modal-bg" id="edit-tx-bg">
      <div id="edit-tx-inner" class="modal" style="max-width:440px">
        ...
        <div class="form-grid">
          ...
          <button class="btn-submit" id="btn-etx-save">Сохранить</button>
        </div>
      </div>
    </div>`;
}
...
Категории расходов (общие для всех направлений): ${catOut}
...
1. ДОХОД (type: "income") — деньги пришли ИЗВНЕ на счёт.
   ...
   Поля: type, amount, currency, direction, account, category, date, note
...
❌ Создавать или изменять направления
...
- Счёт/направление только один и всё очевидно
- Пользователь явно указал счёт или направление
...
- Используй ТОЛЬКО категории из глобального списка выше — они одни для всех направлений
